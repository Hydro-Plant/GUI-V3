...
public class StartScene extends Scene {
	...
	public void updateSize() {
		dashboard.setPosition(variables.height * (1 - constants.height_perc) * gap_factor, variables.height * constants.height_perc + variables.height * (1 - constants.height_perc) * gap_factor);
		dashboard.setShape((variables.width - 3 * variables.height * (1 - constants.height_perc) * gap_factor) / 2, variables.height * (1 - constants.height_perc) * (1 - 2 * gap_factor));
		dashboard_l.setShape((variables.width - 3 * variables.height * (1 - constants.height_perc) * gap_factor) / 2, variables.height * (1 - constants.height_perc) * (1 - 2 * gap_factor));
		dashboard_l.setOutline(variables.height * constants.height_outline);
		
		timelapse.setPosition(variables.width - variables.height * (1 - constants.height_perc) * gap_factor, variables.height * constants.height_perc + variables.height * (1 - constants.height_perc) * gap_factor);
		timelapse.setShape((variables.width - 3 * variables.height * (1 - constants.height_perc) * gap_factor) / 2, variables.height * (1 - constants.height_perc) * (1 - 2 * gap_factor));
		timelapse_l.setShape((variables.width - 3 * variables.height * (1 - constants.height_perc) * gap_factor) / 2, variables.height * (1 - constants.height_perc) * (1 - 2 * gap_factor));
